...
/**
 * ComplementMultinomialNB:
 *
 *
 * @author kostas-κγ 
 */
public class ComplementMultinomialNB extends TextClassifier {

    /**
     * Takes dataset and training data as input.
     * Applies Multivariate Bernouli Naive Bayes.
     */
    public ComplementMultinomialNB
	...
	for(int c = 0; c < 2; c++){
		...
		concatenateTextOfAllDocumentsInComplementClass
		(c, trainingDocuments);
     ...
     *
     */
    private List<Integer> concatenateTextOfAllDocumentsInComplementClass
	...
	for(Document doc: testingDocuments) {	    
	    ...
	    /* argmax score[c] */
	    doc.assignInformative = (logScore[0]>logScore[1]) ? true:false;
