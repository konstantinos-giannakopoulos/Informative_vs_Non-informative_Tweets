 ...
 * @author kostas-κγ 
 */
public class WeightedMultinomialNB extends TextClassifier {

    public double weightFreqHashtags;
    public double weightFreqWords;
    public double weightFreqUsers;
    public double weightSmoothHashtags;
    public double weightSmoothWords;
    public double weightSmoothUsers;
	...
	this.weightSmoothHashtags = weightSmoothHashtags;
	this.weightSmoothWords = weightSmoothWords;
	this.weightSmoothUsers = weightSmoothUsers;
    } // setWeights()
	...
	for(int c = 0; c < 2; c++){
		...
		//double w=h?this.weightFreqHashtags:this.weightFreqWords;
		...
		int cat = this.vocabulary.termCategoryByIndex(v);
		if(cat == 0)
		    ws = this.weightSmoothWords;
	        else if(cat == 1)
		    ws = this.weightSmoothHashtags;
		else if(cat == 2)
		    ws = weightSmoothUsers;
		//boolean h = this.vocabulary.termIsHashTagByIndex(v);
		//double w = h ? this.weightSmoothHashtags : 
		//this.weightSmoothWords; 
